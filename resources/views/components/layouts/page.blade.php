                ...
                <nav
                    ...
                    <div class="md:col-span-3">
                        ...
                        <a class="flex-none inline-block text-xl font-semibold rounded-xl focus:outline-none focus:opacity-80"
                            href="/" wire:navigate aria-label="e-Ping">
                    ...
                    <div class="flex items-center py-1 gap-x-1 md:gap-x-2 ms-auto md:ps-6 md:order-3 md:col-span-3">
                        <a wire:navigate href="/auth/register"
                            class="inline-flex items-center px-3 py-2 text-sm font-medium text-black transition border border-transparent btn-sm gap-x-2 rounded-xl bg-lime-400 hover:bg-lime-500 focus:outline-none focus:bg-lime-500 disabled:opacity-50 disabled:pointer-events-none">
                            Request démo
                        </a>
                        ...
                        <div
                            ...
                            <div>
                                <a class="relative inline-block text-black focus:outline-none before:absolute before:bottom-0.5 before:start-0 before:-z-[1] before:w-full before:h-1 before:bg-lime-400 dark:text-white"
                                    href="#" aria-current="page">Forfaits</a>
                            </div>
                            <div>
    ...
    <footer class="mt-auto w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
        ...
        <div class="grid grid-cols-2 gap-6 mb-10 md:grid-cols-4 lg:grid-cols-5">
            <div class="hidden col-span-full lg:col-span-1 lg:block">
                ...
                <p class="mt-3 text-xs text-gray-600 sm:text-sm dark:text-neutral-400">© 2022 Preline.</p>
            </div>
            <!-- End Col -->
            ...
            <div class="sm:flex sm:justify-between sm:items-center">
                <div class="flex flex-wrap items-center gap-3">
                    ...
                    <div class="hs-dropdown [--placement:top-left] relative inline-flex">
                        <button id="hs-footer-language-dropdown" type="button"
                            ...
                            <svg class="rounded-full size-3" xmlns="http://www.w3.org/2000/svg"
                            ...
                            English (US)
                            <svg class="text-gray-500 hs-dropdown-open:rotate-180 shrink-0 size-4 dark:text-neutral-500"
                                xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round">
                        ...
                        <div class="hs-dropdown-menu w-40 transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden z-10 bg-white shadow-md rounded-lg p-2 dark:bg-neutral-800 dark:border dark:border-neutral-700 dark:divide-neutral-700"
                            ...
                            <a class="flex items-center px-3 py-2 text-sm text-gray-800 rounded-lg gap-x-2 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:text-neutral-400 dark:hover:bg-neutral-700 dark:hover:text-neutral-300 dark:focus:bg-neutral-700 dark:focus:text-neutral-300"
                                href="#">
                ...
                <div class="flex flex-wrap items-center justify-between gap-3">
                    <div class="mt-3 sm:hidden">
                        <a class="flex-none text-xl font-semibold text-black focus:outline-none focus:opacity-80 dark:text-white"
                            href="#" aria-label="Brand">Brand</a>
                        <p class="mt-1 text-xs text-gray-600 sm:text-sm dark:text-neutral-400">© 2022 Preline.</p>
                    </div>
