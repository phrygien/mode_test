...
<div>
    ...
    <div class="relative">
        ...
        <div aria-hidden="true" class="flex -z-[1] absolute -top-48 start-0">
            <div class="bg-purple-200 opacity-30 blur-3xl w-[1036px] h-[600px] dark:bg-purple-900 dark:opacity-20">
            </div>
            <div
        ...
        <div class="max-w-[85rem] px-4 pt-10 sm:px-6 lg:px-8 lg:pt-14 mx-auto">
            ...
            <div
                ...
                <!-- Card -->
                <div
                    class="flex flex-col p-4 text-center bg-white border-2 shadow-xl border-violet-900 rounded-2xl md:p-8 dark:bg-neutral-900 dark:border-violet-700">
                    <p class="mb-3"><span
                    ...
                    <span class="mt-5 text-3xl font-bold text-gray-800 md:text-4xl xl:text-5xl dark:text-neutral-200">
                        $39
                    </span>
                    ...
                    <a class="inline-flex items-center justify-center w-full px-4 py-3 mt-5 text-sm font-medium text-white border border-transparent rounded-lg gap-x-2 bg-violet-600 hover:bg-violet-700 focus:outline-none focus:bg-violet-700 disabled:opacity-50 disabled:pointer-events-none"
            ...
            <div class="w-2/3 mx-auto mt-10 mb-6 text-center sm:w-1/2 lg:w-1/3 md:mt-14 lg:mt-24">
                <h2 class="text-gray-600 dark:text-neutral-400">Trusted by Open Source, enterprise, and more
            ...
            <div class="flex justify-center gap-x-6 sm:gap-x-12 lg:gap-x-24">
                <svg class="mx-auto text-gray-500 size-16 md:size-20 lg:size-24 sm:mx-0 dark:text-neutral-500"
                ...
                <svg class="mx-auto text-gray-500 size-16 md:size-20 lg:size-24 sm:mx-0 dark:text-neutral-500"
                    ...
                    <g fill-rule="evenodd" clip-rule="evenodd">
                        <path fill="currentColor" class="fill-white dark:fill-neutral-900"
    ...
    <div class="relative">
        <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 md:py-14 lg:py-20 mx-auto">
            ...
            <!-- Header -->
            <div class="sticky top-0 hidden py-2 lg:block start-0 bg-white/60 backdrop-blur-md dark:bg-neutral-900/60">
                <!-- Grid -->
            ...
            <div class="space-y-4 lg:space-y-0">
                ...
                <ul class="grid lg:grid-cols-6 lg:gap-6">
                    ...
                    <li class="lg:col-span-2 pb-1.5 lg:py-3">
                        <span class="text-sm font-semibold text-gray-800 lg:font-normal dark:text-neutral-200">
                            Number of seats
                        </span>
                    </li>
                    <!-- End Item -->
                    ...
                    <li class="col-span-1 py-1.5 lg:py-3 border-b border-gray-200 dark:border-neutral-800">
                        <div class="grid grid-cols-2 md:grid-cols-6 lg:block">
                            <span class="text-sm text-gray-800 lg:hidden md:col-span-2 dark:text-neutral-200">
                                Free
                            </span>
                ...
                <ul class="grid lg:grid-cols-6 lg:gap-6">
                    ...
                    <li class="col-span-1 py-1.5 lg:py-3 border-b border-gray-200 dark:border-neutral-800">
                        <div class="grid grid-cols-2 md:grid-cols-6 lg:block">
                            ...
                            <svg class="text-gray-400 shrink-0 size-5 dark:text-neutral-600"
                                xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round">
                                <path d="M5 12h14" />
            ...
            <div class="hidden mt-6 lg:block">
                ...
                <div class="grid grid-cols-6 gap-6">
                    ...
                    <div class="col-span-1">
                        <a class="inline-flex items-center justify-center w-full px-4 py-3 text-sm font-medium text-gray-800 bg-white border border-gray-200 rounded-lg shadow-sm gap-x-2 hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none focus:outline-none focus:bg-gray-50 dark:bg-transparent dark:border-neutral-700 dark:text-neutral-300 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800"
                            href="#">
                            Get started
                        </a>
                    </div>
                    ...
                    <div class="col-span-1">
                        <a class="inline-flex items-center justify-center w-full px-4 py-3 text-sm font-medium text-white border border-transparent rounded-lg gap-x-2 bg-violet-600 hover:bg-violet-700 focus:outline-none focus:bg-violet-700 disabled:opacity-50 disabled:pointer-events-none"
                            href="#">
                            Get started
                        </a>
                    </div>
            ...
            <!-- Button Group -->
            <div class="flex items-center justify-center mt-8 md:mt-12 gap-x-3">
        ...
        <div class="grid gap-10 md:grid-cols-5">
            ...
            <div class="md:col-span-3">
                ...
                <div class="divide-y divide-gray-200 hs-accordion-group dark:divide-neutral-700">
                    <div class="pb-3 hs-accordion active" id="hs-basic-with-title-and-arrow-stretched-heading-one">
                        <button
                            ...
                            <svg class="block text-gray-600 hs-accordion-active:hidden shrink-0 size-5 group-hover:text-gray-500 dark:text-neutral-400"
                                xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                stroke-linecap="round" stroke-linejoin="round">
                                <path d="m6 9 6 6 6-6" />
                            </svg>
                            <svg class="hidden text-gray-600 hs-accordion-active:block shrink-0 size-5 group-hover:text-gray-500 dark:text-neutral-400"
                                xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <div class="pt-6 pb-3 hs-accordion" id="hs-basic-with-title-and-arrow-stretched-heading-three">
                        <button
                            class="inline-flex items-center justify-between w-full pb-3 font-semibold text-gray-800 transition rounded-lg hs-accordion-toggle group gap-x-3 md:text-lg text-start hover:text-gray-500 focus:outline-none focus:text-gray-500 dark:text-neutral-200 dark:hover:text-neutral-400 dark:focus:text-neutral-400"
                            aria-expanded="false"
