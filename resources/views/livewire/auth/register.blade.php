...
<div>
    <!-- Hero -->
    <div class="relative bg-gradient-to-bl from-purple-200 via-transparent dark:from-purple-400 dark:via-transparent">
        <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
            ...
            <div class="grid items-center gap-8 md:grid-cols-2 lg:gap-12">
                <div>
                    <p
                        ...
                        e-ping Management: A vision for 2024
                    </p>
                    ...
                    <div class="max-w-2xl mt-4 md:mb-12">
                        ...
                        {{-- <p class="text-gray-600 dark:text-neutral-400">
                            Nous vous fournissons un compte test qui peut être configuré en quelques secondes. Notre
                            objectif principal est de vous répondre dans les plus brefs délais.
                        </p> --}}
                    </div>
                    <!-- End Title -->
                    ...
                    <blockquote class="relative hidden max-w-sm md:block">
                        <svg class="absolute top-0 text-gray-200 transform -translate-x-6 -translate-y-8 start-0 size-16 dark:text-neutral-800"
                        ...
                        <div class="relative z-10">
                            <p class="text-xl italic text-gray-800 dark:text-white">
                                Des gens formidables avec qui travailler. Partenaire très rapide et professionnel.
                            </p>
                        </div>
                        ...
                        <footer class="mt-3">
                            <div class="flex items-center gap-x-4">
                                ...
                                <div class="grow">
                                    <div class="font-semibold text-gray-800 dark:text-neutral-200">Mécène Phrygien</div>
                ...
                <div>
                    ...
                    <form wire:submit='save'>
                        <div class="lg:max-w-lg lg:mx-auto lg:me-0 ms-auto">
                            <!-- Card -->
                            <div class="flex flex-col p-4 bg-white shadow-lg sm:p-7 rounded-2xl dark:bg-neutral-900">
                                <div class="text-center">
                                    <h1 class="block text-2xl font-bold text-gray-800 dark:text-white">Commencez votre
                                        essai gratuit</h1>
                                ...
                                <div class="mt-5">
                                    ...
                                    <div
                                        class="flex items-center py-3 text-xs text-gray-400 uppercase before:flex-1 before:border-t before:border-gray-200 before:me-6 after:flex-1 after:border-t after:border-gray-200 after:ms-6 dark:text-neutral-500 dark:before:border-neutral-700 dark:after:border-neutral-700">
                                        Or</div>
                      ...
                      autofill:pb-2"
                        ...
                        peer-[:not(:placeholder-shown)]:text-gray-500 dark:peer-[:not(:placeholder-shown)]:text-neutral-500 dark:text-neutral-500">Nom</label>
                                            </div>
                                            <div>
                                                @error('name')
                      ...
                      autofill:pb-2"
                        ...
                        peer-[:not(:placeholder-shown)]:translate-x-0.5
                        peer-[:not(:placeholder-shown)]:-translate-y-1.5
                        peer-[:not(:placeholder-shown)]:text-gray-500 dark:peer-[:not(:placeholder-shown)]:text-neutral-500 dark:text-neutral-500">Prenoms</label>
                                            </div>
                                            <!-- End Floating Input -->
                                        </div>
                                        <!-- End Input Group -->
                      ...
                      autofill:pb-2"
                        ...
                        peer-[:not(:placeholder-shown)]:text-gray-500 dark:peer-[:not(:placeholder-shown)]:text-neutral-500 dark:text-neutral-500">Email</label>
                                        ...
                                        <div>
                                            <!-- Floating Input -->
                                            <div class="relative">
                                                <input type="text" wire:model='etablissement'
                      ...
                      autofill:pb-2"
                        ...
                        peer-[:not(:placeholder-shown)]:translate-x-0.5
                        peer-[:not(:placeholder-shown)]:-translate-y-1.5
                        peer-[:not(:placeholder-shown)]:text-gray-500 dark:peer-[:not(:placeholder-shown)]:text-neutral-500 dark:text-neutral-500">Votre
                                                    établissement</label>
                                            </div>
                                            <!-- End Floating Input -->
                                            <div>
                      ...
                      autofill:pb-2"
                        ...
                        peer-[:not(:placeholder-shown)]:translate-x-0.5
                        peer-[:not(:placeholder-shown)]:-translate-y-1.5
                        peer-[:not(:placeholder-shown)]:text-gray-500 dark:peer-[:not(:placeholder-shown)]:text-neutral-500 dark:text-neutral-500">Mot
                                                    de passe</label>
                                            </div>
                                            <div>
                                                @error('password')
                                            ...
                                            <div id="hs-strong-password-popover"
                                                class="absolute z-10 hidden w-full p-4 bg-gray-100 rounded-lg dark:bg-neutral-950">
                          ...
                          "mode": "popover"
                                                ...
                                                <ul class="space-y-1 text-sm text-gray-500 dark:text-neutral-500">
                                                    <li data-hs-strong-password-hints-rule-text="min-length"
                                                        ...
                                                        Le nombre de caractères minimum est de 6.
                                                    </li>
                                        ...
                                        <div class="col-span-full">
                                            ...
                                            <div class="relative">
                                                ...
                                                <label for="hs-hero-signup-form-floating-input-current-password"
                                                    ...
                                                    peer-[:not(:placeholder-shown)]:translate-x-0.5
                                                    peer-[:not(:placeholder-shown)]:-translate-y-1.5
                                                peer-[:not(:placeholder-shown)]:text-gray-500 dark:peer-[:not(:placeholder-shown)]:text-neutral-500 dark:text-neutral-500">Confirmer
                                                    mot de passe</label>
                                            </div>
                                            <div>
                                    ...
                                    <div class="mt-5">
                                        <button type="submit"
                                            class="inline-flex items-center justify-center w-full px-4 py-3 text-sm font-medium text-white bg-blue-600 border border-transparent rounded-lg gap-x-2 hover:bg-blue-700 focus:outline-none focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none">Valider</button>
                                    </div>
                                </div>
                            </div>
                            <!-- End Card -->
            ...
            <div
                ...
                <span
                    class="font-semibold text-transparent bg-clip-text bg-gradient-to-l from-blue-600 to-violet-500 dark:from-blue-400 dark:to-violet-400">50,000</span>
                les particuliers et les entreprises font confiance à e-ping Management
            </div>

            <!-- Clients -->
            <div class="flex flex-wrap gap-x-6 sm:gap-x-12 lg:gap-x-24">
                <svg class="w-16 h-auto py-3 text-gray-500 lg:py-5 md:w-20 lg:w-24 dark:text-neutral-500"
