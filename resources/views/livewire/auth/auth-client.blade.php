                ...
                <div>
                    ...
                    <form wire:submit='submit'>
                      ...
                      autofill:pb-2"
                        ...
                        peer-[:not(:placeholder-shown)]:text-gray-500 dark:peer-[:not(:placeholder-shown)]:text-neutral-500 dark:text-neutral-500">Adresse
                                                    e-mail</label>
                                            </div>
                                            <!-- End Floating Input -->
                                            <div>
                          ...
                          "mode": "popover"
                                    ...
                                    <div class="mt-5">
                                        <x-button label="Login" class="btn-primary" type="submit" spinner="submit"
                                            class="inline-flex items-center justify-center w-full px-4 py-3 text-sm font-medium btn-primary" />
                                    </div>
                                </div>
                            </div>
                            <!-- End Card -->
