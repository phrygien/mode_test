...
new class extends Component {
    ...
    {
        $this->user = Auth::user();
        $this->subscription = $this->user->activeAbonnement;
    ...
    public function repaid()
    {
        $this->subscription->update([
            ...
            'date_fin_abonnement' => now()->addMonths(),
            'is_paid' => true,
            'is_active' => 1,
            'ends_trial' => null,
            'is_trial' => false,
...
<div>
    ...
    {{-- <x-card>
        ...
        <div class="flex items-center gap-x-3">
            <div class="shrink-0">
                <img class="rounded-full shrink-0 size-16"
        ...
        <div class="mt-8">
            ...
            <p class="mt-3 text-sm text-gray-600 dark:text-neutral-400">
                Currently, I work remotely for Notion, where I design template UIs, convert them into HTML and CSS, and
                ...
                <dd>
                    <ul>
                        ...
                        <li
                            ...
                            <svg class="shrink-0 size-4 me-1" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M3.3448 21.6009L1.41895 0H22.5809L20.653 21.5975L11.987 24L3.3448 21.6009Z"
                                    fill="currentColor" />
                        ...
                        <li
                            class="me-1 after:content-[','] inline-flex items-center text-sm text-gray-800 dark:text-neutral-200">
                            <svg class="shrink-0 size-4 me-1" width="160" height="143" viewBox="0 0 160 143"
                                fill="none">
                                <path
                        ...
                        <li
                            class="me-1 after:content-[','] inline-flex items-center text-sm text-gray-800 dark:text-neutral-200">
                            <svg class="shrink-0 size-4 me-1" width="164" height="143" viewBox="0 0 164 143"
                                fill="none">
                                <path
        ...
        <div class="max-w-[85rem] px-4 py-4 sm:px-6 lg:px-8 mx-auto">
            ...
            <div class="grid justify-center gap-2 md:grid-cols-2 md:justify-between md:items-center">
                <div class="text-center md:text-start">
                    <p class="text-xs tracking-wider uppercase text-white/80">
                        Trial version
                    </p>
                    <p class="mt-1 font-medium text-white">
                        Inscrivez-vous pour recevoir des mises à jour illimitées.
                    </p>
                </div>
                <!-- End Col -->

                <div class="mt-3 text-center md:text-start md:flex md:justify-end md:items-center">
                    <a class="inline-flex items-center px-4 py-3 text-sm font-medium text-gray-800 bg-white border border-gray-200 rounded-full shadow-sm gap-x-2 hover:bg-gray-50 focus:outline-none focus:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-white dark:hover:bg-neutral-800 dark:focus:bg-neutral-800"
                        href="#">
                        Payer maintenant
                    </a>
                </div>
            ...
            <div class="flex flex-col p-4 bg-white shadow-md sm:p-10 rounded-xl dark:bg-neutral-800">
                ...
                <div class="flex justify-between">
                    <div>
                        ...
                        <h1 class="mt-2 text-lg font-semibold text-blue-600 md:text-xl dark:text-white">e-Ping Inc.
                    ...
                    <div class="text-end">
                        <h2 class="text-2xl font-semibold text-gray-800 md:text-3xl dark:text-neutral-200">
                            {{ $subscription->numero_abonnement }}
                        </h2>
                    ...
                    <div class="space-y-2 sm:text-end">
                        ...
                        <div class="grid grid-cols-2 gap-3 sm:grid-cols-1 sm:gap-2">
                            <dl class="grid sm:grid-cols-5 gap-x-3">
                                <dt class="col-span-3 font-semibold text-gray-800 dark:text-neutral-200">Debut:
                                </dt>
                                <dd class="col-span-2 text-gray-500 dark:text-neutral-500">
                                    {{ $subscription->date_debut_abonnement }}</dd>
                            </dl>
                            <dl class="grid sm:grid-cols-5 gap-x-3">
                                <dt class="col-span-3 font-semibold text-gray-800 dark:text-neutral-200">Date fin:</dt>
                                <dd class="col-span-2 text-gray-500 dark:text-neutral-500">
                                    {{ $subscription->date_fin_abonnement }}</dd>
                            </dl>
                        </div>
                        <!-- End Grid -->
                    </div>
